...
const CustomerCheckInForm = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <UnifiedNavbar showBackButton={true} onBackClick={() => navigate(-1)} customTitle="Customer Check-in" />
          ...
          <div className="bg-white/95 backdrop-blur-sm  shadow-xl  ">
            <div className="p-2">
              <div>
                ...
                {!customerData && (
                  <div className="mb-8 p-6 bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 border border-blue-200/50 rounded-xl shadow-lg">
                    ...
                    <p className="text-blue-700 mb-4 text-base">
                      For testing purposes, you can load sample customer data:
                    </p>
                    <button
                      type="button"
                      onClick={() => {
                ...
                {customerData && (
                  <div className="mb-10  ">
                    <div className="bg-gradient-to-br p-1 from-gray-50 via-blue-50 to-indigo-50 rounded-2 border border-gray-200/50 shadow-xl">
