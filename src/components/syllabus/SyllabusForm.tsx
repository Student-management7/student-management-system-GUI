...
const schema = yup
  ...
  .test(
    ...
    (values) => !!(values.file?.[0] || values.textContent?.trim()),
  )
...
const SyllabusForm: React.FC<Props> = ({ onSubmit, loading, defaultValues, isEditMode = false }) => {
  ...
  const [inputType, setInputType] = useState<"file" | "text">(defaultValues?.textContent ? "text" : "file")
  ...
  const sortedClassData = useMemo(() => sortArrayByKey(classData, "className"), [classData])
      ...
      <div className="container mx-auto">
        ...
        <form onSubmit={handleSubmit(onSubmitHandler)} className="space-y-6">
          ...
          <div className="flex flex-col">
            ...
            <input {...register("title")} className="p-2 form-control max-w-md" placeholder="Enter syllabus title" />
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="flex flex-col w-full md:max-w-sm">
              ...
              <select {...register("class")} className="p-2 form-control" disabled={!classDataLoaded}>
            ...
            >
              <div className="flex flex-col items-center">
                ...
                <input
                  ...
                  id="file-upload"
                />
                <label htmlFor="file-upload" className="mt-3 px-4 py-2 btn button">
                  Select File
                </label>
              </div>
              {watchedFile?.[0]?.name && (
